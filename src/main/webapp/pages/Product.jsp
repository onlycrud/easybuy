    ...
    <div class="content">
        ...
        <div class="pro_des">
            ...
            <div class="des_price">
                ...
                消费积分：<span><fmt:formatNumber pattern="0">${product.price / 10}</fmt:formatNumber> R</span>
            </div>
            ...
            <div class="des_share">
                ...
                <div class="d_care"><a id="addCollection" onclick="ShowDiv('MyDiv','fade')">关注商品</a></div>
            </div>
            <div class="des_join">
                <div class="j_nums">
            ...
            <div class="notice_c">
                ...
                <table border="0" align="center" style="margin-top:;" cellspacing="0" cellpadding="0">
                    ...
                    <tr height="50" valign="bottom">
                        <td>&nbsp;</td>
                        <td><a href="#" class="b_sure" id="collection_b_sure">确定</a></td>
                    </tr>
                </table>
                ...
                <table border="0" align="center" style="margin-top:;" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            购物车共有${sessionScope.user.shoppings.size()}件宝贝 &nbsp; &nbsp;
                        </td>
                    </tr>
                    <tr height="50" valign="bottom">
                        <td>&nbsp;</td>
                        <td><a href="showBuyCar.do" class="b_sure" id="shopping_b_sure">去购物车结算</a><a href="Index.do"
                                                                                                     class="b_buy">继续购物</a>
                        </td>
                    </tr>
                </table>
